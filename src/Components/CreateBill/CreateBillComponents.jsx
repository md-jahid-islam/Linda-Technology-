...
const CreateBillComponents = () => {
    ...
    return (
        ...
        {/* 🔵 Header Section */}
         ...
         <img src="/images/ms.jpg.png" alt="logo" className="w-24 h-24 sm:w-32 sm:h-32 rounded-full object-cover border-4 border-red-500 shadow-md"/>
         </div>
      ...
      {/* Right - Company Info */}
         <div className="flex-1 flex flex-col justify-center text-center sm:text-left">
           ...
           <p className="text-xs sm:text-sm text-black font-medium italic">
             {slogan}
           </p>
           <p className="text-[10px] sm:text-xs text-black mt-1 leading-tight">
             {address}
           </p>
           ...
           <p className="text-xs text-black mt-1">
             Website:{" "}
             <a href={`http://${website}`} target="_blank" rel="noopener noreferrer" className="hover:underline font-semibold">
             {website}
             </a>{" "}
             |E-mail: {email}
           </p>
